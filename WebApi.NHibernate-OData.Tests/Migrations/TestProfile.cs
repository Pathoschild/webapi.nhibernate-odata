	...
	public class TestProfile : ForwardOnlyMigration
	{
		public override void Up()
		{
			this.Insert.IntoTable("Parents")
				...
				.Row(new { Id = 63, Name = "parent 63", CreatedOn = new DateTime(2014, 1, 2), Value = 45.15m, Component_One = "One63", Component_Two = 63, Component_Three = "Three63", Component_Four = "Four63" });
